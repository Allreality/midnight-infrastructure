...
╠════════════════════════════════════════════════════════════════╣
║  📂 Serving from: {DIRECTORY[:45]:<45} ║
║  🔗 Diagnostic:   http://localhost:{PORT}/phantom-test.html{' '*14}║
║  🚀 Main App:     http://localhost:{PORT}/midnight-x402-fixed.html{' '*6}║
║                                                                ║
...
## 📁 Save it as:
```
C:\projects\midnight-infrastructure\frontend_server.py